...
function UserPage() {
  return (
    <div>
        ...
        <UserPost likes={883} replies={3} postImg={"/post1.png"} postTitle={"This is Post 1 with Post Image and Title"}/>
        <UserPost likes={7113} replies={21} postImg={"/post3.png"} postTitle={"This is Post 1 with Post Image and Title"}/> */}
    </div>
  )
}
